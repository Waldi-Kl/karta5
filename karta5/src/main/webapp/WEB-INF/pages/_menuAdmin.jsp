    ...
    <a href="${pageContext.request.contextPath}/" class="w3-bar-item w3-button w3-padding-16"><i
		...
		<a href="${pageContext.request.contextPath}/admin"
			...
			<div class="w3-dropdown-content w3-card-4 w3-bar-block">
				<a href="${pageContext.request.contextPath}/userInfo/list" class="w3-bar-item w3-button">Lista</a>
				<a href="${pageContext.request.contextPath}/userInfo/user" class="w3-bar-item w3-button">Zarządzaj</a>
			</div>
		</div>
