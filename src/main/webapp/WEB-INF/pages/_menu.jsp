		...
		<div class="w3-row">
			<div class="w3-col s9 w3-center">
				<a href="${pageContext.request.contextPath}/"
					...
					<a href="${pageContext.request.contextPath}/admin/settingsPages"
					class="w3-bar-item w3-button w3-padding-16">Ustawienia</a>
...
<a href="${pageContext.request.contextPath}/statistics/"
					class="w3-bar-item w3-button w3-padding-16">Statystyki</a>
			</div>
			<!-- 	------------------------------------------ login info  -------------------------  -->
