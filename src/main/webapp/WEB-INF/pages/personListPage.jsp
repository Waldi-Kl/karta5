...
<body>
	<jsp:include page="_menuPerson.jsp" />
			...
			<div class="w3-border">
						...
						<table class="w3-table w3-striped w3-border" id="userTable">
							...
							<c:forEach var="person" items="${persons}">
								<tr>
									...
									<td>${person.date}</td>
									<td><a
										href="${pageContext.request.contextPath}/userInfo/user/${person.surname}"
										class="w3-button w3-theme" role="button">Edycja</a></td>
				...
				<div id="AddUser" class="w3-container tab w3-animate-opacity">
					<!-- <form class="w3-container w3-card-4" name="userForm"
						...
						onsubmit="return validateUserForm()" object="${newUser}"
						method='POST'>
